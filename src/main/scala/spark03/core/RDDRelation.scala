...
object RDDRelation {
  def main(args: Array[String]): Unit = {
    ...
    /** The result of SQL queries are themselves RDDs and support all normal RDD functions.
      * The items in the RDD are of type of Row, which allows you to access each column by ordinal. */
